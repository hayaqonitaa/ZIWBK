...
<div class="modal fade" id="addContentStandarPelayanan" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-simple modal-enable-otp modal-dialog-centered">
    <div class="modal-content p-3 p-md-5">
      <div class="modal-body">
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        <div class="text-center mb-4">
          <h3 class="mb-2">Add Content Standar Pelayanan</h3>
        </div>
        <form id="addContentStandarPelayananForm" class="row g-3" enctype="multipart/form-data">
