<!-- Edit Prodi Modal -->
<div class="modal fade" id="editContentLayananPengaduan" tabindex="-1" aria-labelledby="editContentLayananPengaduanLabel" aria-hidden="true">
  <div class="modal-dialog modal-simple modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="editContentLayananPengaduanLabel">Edit Prodi</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form id="editContentLayananPengaduanForm">
          <input type="hidden" id="editContentLayananPengaduanId" name="id">
          ...
          <div class="mb-3">
            <label for="editDeskripsi" class="form-label">Link</label>
