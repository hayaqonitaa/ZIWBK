    ...
    <div class="modal-content p-3 p-md-5">
      <div class="modal-body">
        ...
        <div class="text-center mb-4">
          <h3 class="mb-2">Upload Hasil Survey</h3>
        </div>

        <!-- Button untuk Download Template -->
        <label for="file" class="form-label">Download Template</label>
        <div class="text-start mb-3">
          <a href="{{ route('hasil_survey.download-template') }}" class="btn btn-success">
            Download Template Excel
          </a>
        </div>

        <form id="uploadExcelForm" action="{{ route('hasil_survey.import') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="mb-3">
