...
$(function () {
  ...
  if (dt_scrollable_table.length) {
    var dt_scrollableTable = dt_scrollable_table.DataTable({
      ajax: {
        url: '/content/agen_perubahan/data', // ini ke web.php
      ...
      columns: [
        ...
        { 
            ...
            render: function (data, type, row) {
                ...
                return `<img src="/storage/uploads/${data}" alt="${row.judul}" style="width: 100px; height: auto;">`;
            }
        },
    ...
    $('#editContentAgenPerubahan').on('show.bs.modal', function (event) {
