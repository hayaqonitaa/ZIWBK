...
class ContentLayananPengaduanController extends Controller
{
    public function index()
    {
        return view('konten.layanan_pengaduan.layanan_pengaduan');
    }
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'file' => 'required|image|mimes:jpeg,png,jpg,gif|max:5120', // Max file size 2MB
